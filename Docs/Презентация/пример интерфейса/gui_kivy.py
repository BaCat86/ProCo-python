...
#         )
#
#         tags = BoxLayout(orientation='vertical', spacing=10)
#         for i in range(1, 4):
...
#             ))
#
#         contacts = BoxLayout(orientation='vertical', spacing=10)
...
class DynamicInterface(BoxLayout):
    def __init__(self, **kwargs):
        super(DynamicInterface, self).__init__(**kwargs)
        ...
        self.button = Button(text='Обновить текст')
